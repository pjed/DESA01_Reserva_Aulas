    ...
    <body>
        <%
            ...
            if (session.getAttribute("usuarioLog") != null) {
                existeUsuario = (Usuario) session.getAttribute("usuarioLog");
                Bitacora.Bitacora.escribirBitacora("El usuario gestiona usuarios ", existeUsuario.getCorreo(), "Admin General");
            }
